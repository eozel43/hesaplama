...
<head>
    ...
    <title>Eşel Mobil Hesaplayıcı</title>
    <!-- Tailwind CSS -->
...
<body>
    ...
    <script type="text/babel">
        ...
        // --- TYPE DEFINITIONS ---
        // (Interfaces are not used in JS, but kept as comments for clarity)
        /*
        ...
        */
        ...
        // Mock data for Minimum Wage (Asgari Ücret)
        const ASGARI_UCRET_MOCK_DATA = {
            '2025': 22104,
        };
        ...
        function InputSection({ title, data, onDataChange, color, infoLink, years }) {
            const colorClasses = {
            ...
            const renderPeriodInputs = (period) => (
        ...
        function ResultCard({ title, data, result, valueType, weightedLabel, color }) {
            const getFullName = (month, year) => {
        ...
        function App() {
            ...
            const calculateChange = (data, weight) => {
            ...
            const getStatusIconTotal = (change) => {
